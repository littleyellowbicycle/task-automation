...
```
 ...
 |                            External Systems                              |
 |  +-------------+      +-------------+      +-------------+              |
 |  |  WeCom      |      |  Feishu     |      |  Browser    |              |
 |  |  (Messages) |      |  (Callback) |      |  (Console)  |              |
 |  +------+------|      +------+------|      +------+------|              |
 +---------|-------------------|-------------------|------------------------+
           |                   |                   |
           v                   v                   v
 +--------------------------------------------------------------------------+
 |                     API Gateway (Public Network)                          |
 |                                                                          |
 |  +-------------+  +-------------+  +-------------+  +-------------+     |
 |  | Message     |  | Task        |  | Queue       |  | Message     |     |
 |  | Processor   |  | Manager     |  | Manager     |  | Router      |     |
 |  | (Dedup)     |  | (State)     |  | (FIFO)      |  | (Dispatch)  |     |
 |  +-------------+  +-------------+  +-------------+  +-------------+     |
 |                                                                          |
 |  REST: /listener/*  /feishu/*  /decisions/*  /tasks/*  /queue/*  /health|
 +------|-----------|-----------|-----------|-------------------------------+
        |           |           |           |
        v           v           v           v
 +-------------+ +-------------+ +-------------+ +-------------+
 | Analysis    | | Decision    | | Execution   | | Recording   |
 | Worker      | | Worker      | | Worker      | | Worker      |
 |             | |             | |             | |             |
 | - Filter    | | - Card Push | | - OpenCode  | | - Feishu    |
 | - Classify  | | - Confirm   | | - Code Gen  | | - Record    |
 | - LLM       | | - Timeout   | | - Collect   | | - Notify    |
 +-------------+ +-------------+ +-------------+ +-------------+
```
